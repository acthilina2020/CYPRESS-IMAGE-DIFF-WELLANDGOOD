describe("Open Widget spf", () => {
  it("Compare the open widget", () => {
    cy.visit("https://www.wellandgood.com/skin-care-dupes/");
    cy.wait(6000);
    cy.get(":nth-child(16) > .wg-inline-shopable").scrollIntoView();
    cy.get(":nth-child(16) > .wg-inline-shopable").should("be.visible");
    cy.wait(2000);
    cy.get(":nth-child(16) > .wg-inline-shopable").click();
    cy.wait(6000);
    cy.get(
    ...
    ).compareSnapshot("spf widget open", 0.4);
  });
});
